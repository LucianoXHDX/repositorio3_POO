...
public class PropiedadLucianoCarril_21117582{
    private int id;
    private String nombre;
    private int precio;
    private int renta;
    private JugadorLucianoCarril_21117582 duenno;
     ...
     * @param duenno es dueno de la propiedad, es de tipo JugadorLucianoCarril_21117582
   ...
   public int getPropiedadRenta() {
    ...
    /**
     * esta funcion devuelve el duenno de la funcion que sera del tipo JugadorLucianoCarril_21117582
     * @return duenno
     */
    public JugadorLucianoCarril_21117582 getPropiedadDuenno(){
        return duenno;
    }
    /**
     ...
     * 
     */
    public void setPropiedadDuenno(JugadorLucianoCarril_21117582 jugador){
        this.duenno=jugador;
    }
    public void agregarUnaCasa() {
    this.casas++;
    }
    public boolean setHipotecadapropiedad(){
